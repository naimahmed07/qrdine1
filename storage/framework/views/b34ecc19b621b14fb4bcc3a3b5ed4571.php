        ...
        <div class="relative p-3 w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="px-4 pb-3 md:px-5 md:pb-4">
                    <form class="space-y-4" action="<?php echo e(route('categories.store')); ?>" method="POST" id="add-category-form">
                        <?php echo csrf_field(); ?>
...
<?php $component = App\View\Components\Form\Input::resolve(['label' => 'Category Name','type' => 'text','name' => 'name','id' => 'name','placeholder' => 'Enter category name','required' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component = App\View\Components\Button::resolve(['type' => 'submit','id' => 'add-category-btn','usage' => 'create'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="px-4 pb-3 md:px-5 md:pb-4">
                    <form class="space-y-4" action="" method="POST" id="update-category-form">
                        ...
                        <?php if (isset($component)) { $__componentOriginalc1d2405c7f8100d77292f2d0299ccd96 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc1d2405c7f8100d77292f2d0299ccd96 = $attributes; } ?>
<?php $component = App\View\Components\Form\Input::resolve(['label' => 'Category Name','type' => 'text','name' => 'name','id' => 'update-name','placeholder' => 'Enter category name','required' => 'true'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('form.input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Form\Input::class))->getConstructor()): ?>
...
<?php endif; ?>
                        ...
                        <?php if (isset($component)) { $__componentOriginale67687e3e4e61f963b25a6bcf3983629 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale67687e3e4e61f963b25a6bcf3983629 = $attributes; } ?>
<?php $component = App\View\Components\Button::resolve(['type' => 'submit','id' => 'update-category-btn','usage' => 'update'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Button::class))->getConstructor()): ?>
                ...
                <tbody>
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr
                            ...
                            <td class="px-6 py-4">
                                <?php echo e($category->active ? 'Yes' : 'No'); ?>

                            </td>
                            <td class="px-6 py-4">
                                <?php echo e($category->created_at->setTimezone('GMT')->format('d M Y, H:i:s')); ?> GMT
                            </td>
                            <td class="px-6 py-4 flex gap-x-3 text-right">
                                <button data-modal-target="update-category-modal"
                                    ...
                                    type="button"
                                    onclick="editCategory('<?php echo e($category->id); ?>', '<?php echo e($category->name); ?>', '<?php echo e($category->active); ?>', '<?php echo e(route('categories.update', ['category' => $category->id])); ?>')">
                                ...
                                dark:hover:bg-red-600 dark:focus:ring-red-700"
                                    type="button" onclick="categoryToDelete('<?php echo e($category->id); ?>')">
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/mahfuz/Codes/side-projects/QRDine/resources/views/categories/index.blade.php ENDPATH**/ ?>