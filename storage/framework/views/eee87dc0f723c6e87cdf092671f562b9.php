            ...
            <tbody>
                <?php $__currentLoopData = $coupons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coupon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr
                        ...
                        <td class="px-6 py-4"><?php echo e($coupon->name); ?></td>
                        <td class="px-6 py-4"><?php echo e($coupon->code); ?></td>
                        <td class="px-6 py-4"><?php echo e($coupon->type); ?></td>
                        <td class="px-6 py-4"><?php echo e($coupon->value); ?></td>
                        <td class="px-6 py-4"><?php echo e(\Carbon\Carbon::parse($coupon->valid_from)->format('M d, Y')); ?></td>
                        <td class="px-6 py-4"><?php echo e(\Carbon\Carbon::parse($coupon->valid_to)->format('M d, Y')); ?></td>
                        <td class="px-6 py-4"><?php echo e($coupon->limit); ?></td>
                        <td class="px-6 py-4"><?php echo e($coupon->used); ?></td>

                        <td class="px-6 py-4"><?php echo e($coupon->active ? 'Yes' : 'No'); ?></td>
                        <td class="px-6 py-4 flex gap-x-3 text-right">
                            ...
                            <button
                                ...
                                type="button" onclick="confirmDelete('<?php echo e($coupon->id); ?>')">
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/mahfuz/Codes/side-projects/QRDine/resources/views/coupons/index.blade.php ENDPATH**/ ?>